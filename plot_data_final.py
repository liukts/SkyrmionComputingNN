...
dir = './context/'
base = np.load(dir + '0920_tskone_baseline_lr2.0/accuracies.npy')
direct = np.load(dir + '0920_tskone_direct_lr0.8/accuracies.npy')
cont0 = np.load(dir + '0920_tskone_context_lr0.1/accuracies.npy')
cont1 = np.load(dir + '0920_tskone_context_lr0.3_dummy1/accuracies.npy')
