...
dir = './context/'
base = np.load(dir + '0725_tskone_baseline/accuracies.npy')
direct = np.load(dir + '0725_tskone_direct/accuracies.npy')
cont = np.load(dir + '0725_tskone_context/accuracies.npy')
